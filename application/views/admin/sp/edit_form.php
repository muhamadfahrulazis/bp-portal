      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <form action="<?php base_url('admin/sp/edit') ?>" method="post" enctype="multipart/form-data">
                    
                    <input type="hidden" name="id" value="<?php echo $sp->sp_id ?>"/>
                    
                    <div class="form-group">
                        <label for="sp_name">Name*</label>
                        <input class="form-control <?php echo form_error('sp_name') ? 'is-invalid':'' ?>"
                               type="text" name="sp_name" value="<?php echo $sp->sp_name ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo form_error('finished_order') ? 'is-invalid':'' ?>"
                               type="number" name="finished_order" min="0" value="<?php echo $sp->finished_order ?>" />
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?php echo form_error('domisili') ? 'is-invalid':'' ?>"
                                  name="domisili" placeholder="Domisili..."><?php echo $sp->domisili ?></textarea>
                        <div class="invalid-feedback">
